...
def time_features_from_frequency_str(freq_str: str) -> List[TimeFeature]:
    ...
    offset = to_offset(freq_str)  # freq_str='h',偏移量为1hour
...
def time_features(dates, timeenc=1, freq='5min'):
    """
    ...
    *minute returns a number from 0-3 corresponding to the 15 minute period it falls into.
    ...
    if timeenc==1:
        ...
        return np.vstack([feat(dates) for feat in time_features_from_frequency_str(freq)]).transpose(1,0)  # 行堆叠
