...
__all__ = ['RepVGG', 'RepVGG_A0', 'RepVGG_A1', 'RepVGG_A2', 'RepVGG_B0', 'RepVGG_B1',
           'RepVGG_B1g2', 'RepVGG_B1g4', 'RepVGG_B2', 'RepVGG_B2g2', 'RepVGG_B2g4',
...
def RepVGG_A0(**kwargs):
    return RepVGG(block_nums=[2, 4, 14, 1], width_multiplier=[0.75, 0.75, 0.75, 1.], group=1, deploy=False, **kwargs)

def RepVGG_A1(**kwargs):
    return RepVGG(block_nums=[2, 4, 14, 1], width_multiplier=[1, 1, 1, 2.5], group=1, deploy=False, **kwargs)

def RepVGG_A2(**kwargs):
    return RepVGG(block_nums=[2, 4, 14, 1], width_multiplier=[1.5, 1.5, 1.5, 2.75], group=1, deploy=False, **kwargs)

def RepVGG_B0(**kwargs):
    return RepVGG(block_nums=[4, 6, 16, 1], width_multiplier=[1, 1, 1, 2.5], group=1, deploy=False, **kwargs)

def RepVGG_B1(**kwargs):
    return RepVGG(block_nums=[4, 6, 16, 1], width_multiplier=[2, 2, 2, 4], group=1, deploy=False, **kwargs)

def RepVGG_B1g2(**kwargs):
    return RepVGG(block_nums=[4, 6, 16, 1], width_multiplier=[2, 2, 2, 4], group=2, deploy=False, **kwargs)

def RepVGG_B1g4(**kwargs):
    return RepVGG(block_nums=[4, 6, 16, 1], width_multiplier=[2, 2, 2, 4], group=4, deploy=False, **kwargs)


def RepVGG_B2(**kwargs):
    return RepVGG(block_nums=[4, 6, 16, 1], width_multiplier=[2.5, 2.5, 2.5, 5], group=1, deploy=False, **kwargs)

def RepVGG_B2g2(**kwargs):
    return RepVGG(block_nums=[4, 6, 16, 1], width_multiplier=[2.5, 2.5, 2.5, 5], group=2, deploy=False, **kwargs)

def RepVGG_B2g4(**kwargs):
    return RepVGG(block_nums=[4, 6, 16, 1], width_multiplier=[2.5, 2.5, 2.5, 5], group=4, deploy=False, **kwargs)


def RepVGG_B3(**kwargs):
    return RepVGG(block_nums=[1, 4, 6, 16, 1], width_multiplier=[3, 3, 3, 5], group=1, deploy=False, **kwargs)

def RepVGG_B3g2(**kwargs):
    return RepVGG(block_nums=[1, 4, 6, 16, 1], width_multiplier=[3, 3, 3, 5], group=2, deploy=False, **kwargs)

def RepVGG_B3g4(**kwargs):
    return RepVGG(block_nums=[1, 4, 6, 16, 1], width_multiplier=[3, 3, 3, 5], group=4, deploy=False, **kwargs)
